...
class TagPredictorNN(nn.Module):
    ...
    def evaluate(self, data_loader, threshold=0.5, device: str = "cpu"):
        ...
        # Compute metrics
        jaccard = jaccard_score(all_y_true, all_y_pred, average='samples', zero_division=0)
        precision = precision_score(all_y_true, all_y_pred, average='samples', zero_division=0)
        recall = recall_score(all_y_true, all_y_pred, average='samples', zero_division=0)
